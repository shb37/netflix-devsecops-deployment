...
pipeline {
    ...
    stages {
        ...
        stage('Checkout from Git') {
            steps {
                git branch: 'main', url: 'https://github.com/shb37/nextflix.git'
            }
        }
        ...
        stage("Docker Build Image"){
            steps{
                ...
                sh "docker build --build-arg API_KEY=2af0904de8242d48e8527eeedc3e91d9 -t netflix ."
            }
        }
        stage("TRIVY"){
            steps{
        ...
        stage("Docker Push"){
            steps{
                script {
                    ...
                    sh "docker tag netflix shb37/netflix:latest "
                    sh "docker push shb37/netflix:latest"
                    }
                }
            }
        }
